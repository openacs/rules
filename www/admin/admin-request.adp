...
function get_interval() {
        ...
        destination = "admin-request?community=@default_community@&state=@default_state@&interval="+interval;
...
function get_specific_date() {
        ...
        destination = "admin-request?community=@default_community@&state=@default_state@&interval=@default_interval@&specific_date="+date;
        if (destination) location.href = destination;
...
function get_community() {
        ...
        destination = "admin-request?state=@default_state@&interval=@default_interval@&specific_date=@default_specific_date@&community="+community;
        if (destination) location.href = destination;
...
function get_state() {
        ...
        destination = "admin-request?community=@default_community@&interval=@default_interval@&specific_date=@default_specific_date@&state="+state;
         if (destination) location.href = destination;
