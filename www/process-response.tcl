...
"                
                append notif_text "A user has joined to the system                                             User Name:  $user_info@viaro.net" 
   ...
   append notif_text "
                      You can visit this rule history at http://216.230.130.230:3500/rules/admin/admin-request
   "
   notification::new -type_id [notification::type::get_type_id -short_name rule_notif] -object_id $rule_id -notif_subject "$rule_name" -notif_text $notif_text
}
